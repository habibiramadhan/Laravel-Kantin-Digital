                ...
                <div class="col-sm-12 text-center align-self-center">
                    <div class="mm-error position-relative">
                        <img src="../assets/images/error/404.png"
                            class="img-fluid mm-error-img mm-error-img-dark mx-auto" alt="">
                        <img src="../assets/images/error/404-dark.png" class="img-fluid mm-error-img" alt="">
                        <h2 class="mb-0 mt-4">Oops! Halaman Ini Tidak Ditemukan.</h2>
                        <p>Halaman yang diminta tidak ada.</p>
                        <a class="btn btn-primary d-inline-flex align-items-center mt-3" href="{{route('welcome')}}"><i
                                class="ri-home-4-line"></i>kembali ke beranda</a>
                    </div>
                </div>
            </div>
        </div>
